...
public class TestEnemy extends Controllable{
    ...
    public TestEnemy(Map map, TestPlayer player, Tile startTile, float relativeSize) throws Controllable.InvalidStartTileException
    {
    ...
    private Controllable.Direction getDirectionToPlayer()
    {
        ...
        return Controllable.Direction.getClosestDir(angleToPlayer);
    }
